...
from models_igev.core.utils import frame_utils
from models_igev.core.utils.augmentor import FlowAugmentor, SparseFlowAugmentor
...
class SceneFlowDatasets(StereoDataset):
    ...
    def __init__(self, aug_params=None, root='/storage/datasets/kitti/sceneflow/train/', dstype='frames_finalpass', things_test=False):
...
class ETH3D(StereoDataset):
    def __init__(self, aug_params=None, root='/storage/datasets/kitti/eth3d/', split='training'):
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/storage/datasets/kitti/stereo_2015/', image_set='training'):
        super(KITTI, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI)
        assert os.path.exists(root)

        root_12 = '/storage/datasets/kitti/stereo_2012/'
        ...
        root_15 = '/storage/datasets/kitti/stereo_2015/'
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/storage/datasets/kitti/middlebury_2014/MiddEval3/', split='F'):
