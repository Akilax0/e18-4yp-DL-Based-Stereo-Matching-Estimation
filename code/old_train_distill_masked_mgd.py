...
Incoperate generated features to the pipeline
...
# # 
from models_mgd import __models__, model_loss_train, model_loss_test,KD_feat_loss,KD_cvolume_loss,KD_deconv8,KD_deconv4
...
def train_sample(sample, compute_metrics=False):
    ...
    teacher = {}
    teacher['t_feat'] = t_feat
    teacher['t_cvolume'] = t_cvolume
    teacher['t_conv4'] = t_conv4
    teacher['t_conv8'] = t_conv8
    
    teacher['kd_loss'] = 0
    teacher['feat_loss'] = 0
    teacher['cvolume_loss'] = 0
    teacher['conv4_loss'] = 0
    teacher['conv8_loss'] = 0

    teacher['lambda_feat'] = 0.001
    teacher['lambda_cvolume'] = 0
    teacher['lambda_conv4'] = 0
    teacher['lambda_conv8'] = 0

    teacher['lambda_mgd'] = 0.5

    disp_ests,kd_loss = model(imgL, imgR, teacher)
    ...
    # masking for the final disparity map
...
def test_sample(sample, compute_metrics=True):
    ...
    # to handle empty dict in ref
    teacher = {}
    disp_ests = model(imgL, imgR, teacher)
