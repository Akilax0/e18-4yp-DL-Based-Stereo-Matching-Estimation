...
from models import __models__, model_loss_train, model_loss_test, model_loss_train_v2, model_loss_train_v3
from utils import *
...
if args.resume:
    ...
    print("state dict resume: ",state_dict.keys())
    ...
    print("state dict checkpoint : ",state_dict.keys())
...
def train_sample(sample, compute_metrics=False):
    model.train()
    imgL, imgR, disp_gt, disp_gt_2, disp_gt_4 = sample['left'], sample['right'], sample['disparity'], sample['disparity_2'], sample['disparity_4']
    imgL = imgL.cuda()
    imgR = imgR.cuda()
    disp_gt = disp_gt.cuda()
    disp_gt_2 = disp_gt_2.cuda()
    ...
    mask_2 = (disp_gt_2 < args.maxdisp) & (disp_gt_2 > 0)
    mask_4 = (disp_gt_4 < args.maxdisp) & (disp_gt_4 > 0)
    masks = [mask, mask_2, mask_4]
    disp_gts = [disp_gt, disp_gt_2, disp_gt_4]
