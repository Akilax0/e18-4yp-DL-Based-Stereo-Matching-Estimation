...
parser.add_argument('--loadckpt', default='./pretrained/acv_sceneflow.ckpt',help='load the weights from a specific checkpoint')
...
model = __t_models__[args.model](args.maxdisp, args.attention_weights_only, args.freeze_attention_weights)
...
for i in trange(len(test_limg)):
    ...
    # print("Sizes: ",predict_np, mask, disp_gt)
